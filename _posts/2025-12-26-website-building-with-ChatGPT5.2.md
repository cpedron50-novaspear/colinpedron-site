---
layout: post
title: "Setting up this site using AI (w/o the need for templates)"
date: 2025-12-26
description: "Notes on how this site was built, and why I kept it intentionally simple."
tags: [website, tooling, ai]
---
...
There were a few hiccups along the way (such as the fact that the original link needed to be HTTPS for web safety, which is harder to set up than you'd think). All issues were ultimately resolved over the course of 2 days. I took lots of little pauses along the way to ask the AI model to explain further. Typically this consisted of me sending screenshots of error messages or (more commonly) asking it to rewind back to earlier instructions to remove coder jargon and just explain what I needed to do in plain english. 
...
If you’re building a personal site, resist the urge to overbuild it. Start with the minimum system that does the job and stays out of your way. And definitely don't pay for fancy templates that you don't need. That might've been necessary in the past, but now we can use AI to skip past that template stage. 

I'll expand one step further to close out my inaugural post (and yeah, this'll probably become a theme in this blog): It's 2026. Just use AI to supercharge any and all digital work. If that idea in your head can exist on a computer, then AI (+ a bit of time and elbow grease on your part) can probably build it better and cheaper than whatever alternative method/platform you're imagining. 
